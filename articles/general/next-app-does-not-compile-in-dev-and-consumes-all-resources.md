---
title: Next app won't compile in dev and consumes all CPU resources
date: 2026-03-13
category: general
---
...
The solution is nice an simple: delete the `.next` folder. Then run `npm install` and you'll be right as rain.
