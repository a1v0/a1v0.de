			...
			<div className="bg-accent-colour dark:bg-dark-mode-background-grey dark:text-dark-mode-accent-colour">
				<header className="clear-gutters py-16">
					<h1 className="m-auto p-0">
						...
						<span className="dark:text-dark-mode-brand-colour text-softer-black block">
							Better luck next time.
						</span>
					</h1>
				</header>
			</div>
			<div className="text-content bg-background-white dark:bg-dark-mode-background-grey dark:text-dark-mode-text-light grow">
