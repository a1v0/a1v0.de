...
export default function Home() {
	return (
		<main className="flex grow flex-col bg-background-white">
			<div className="bg-accent-colour dark:bg-softer-black dark:text-accent-colour">
			...
			<div className="grow dark:bg-text-dark dark:text-background-white">
			...
			<div className="grow bg-background-grey dark:bg-softer-black dark:text-background-white">
				<article className="clear-gutters text-content">
					<h2>About me</h2>
					<p>
