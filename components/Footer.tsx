...
function Footer() {
	return (
		<footer className="dark:bg-dark-mode-background-dark-grey dark:text-dark-mode-text-light dark:[&_a]:text-dark-mode-text-light bg-brand-colour py-2 [&_a]:text-text-dark">
