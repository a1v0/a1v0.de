...
function Footer() {
	return (
		<footer className="bg-brand-colour dark:bg-dark-mode-background-dark-grey dark:text-dark-mode-text-light [&_a]:text-text-dark dark:[&_a]:text-dark-mode-text-light dark:[&_a]:active:text-text-dark py-2">
			<div className="clear-gutters flex items-center justify-between">
				<section className="flex grow-3 flex-col">
					<p className="m-0">
						Copyright &copy; {new Date().getFullYear()}{" "}
						<strong className="font-medium">a1v0.de</strong>.
					</p>
