...
ServiceNow takes this response and creates a transform map from the data contained in it. Specifically, it looks for any attributes (contained within an `<Attribute>` tag).
